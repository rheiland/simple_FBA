...
#  plt.scatter(xvals,yvals, s=rvals*scale_radius, c=rgbs)
  alpha_val = 0.5
#  plt.scatter(xvals,yvals, s=rvals*scale_radius, c=rgbs, alpha=alpha_val, edgecolor='black')
  plt.scatter(xvals,yvals, s=rvals*scale_radius, c=rgbs, alpha=alpha_val)
#  plt.scatter(xvals,yvals, s=rvals*scale_radius, c=rgbs)
